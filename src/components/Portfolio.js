      ...
      <section>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-6 col-lg-4">
            <a href="https://ashraysr.github.io/Ethnus-Submission-1-21BCE2036/" className="card-link">
          ...
          <div className="col-sm-12 col-md-6 col-lg-4">
            <a href="https://ashraysr.github.io/Ethnus-Submission-2-21BCE2036/" className="card-link">
